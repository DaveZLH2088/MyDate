...
public class AppController {
	...
	public String getAppInfoList(Model model,HttpSession session,
		...
		return "/WEB-INF/jsp/developer/appinfolist.jsp";
	}
	...
	public String add(@ModelAttribute("appInfo") AppInfo appInfo){
		return "/WEB-INF/jsp/developer/appinfoadd.jsp";
	}
	...
	public String addVersion(@RequestParam(value="id")String appId,
		...
		return "/WEB-INF/jsp/developer/appversionadd.jsp";
	}
	/**
	...
	public String view(@PathVariable String id,Model model){
		...
		return "/WEB-INF/jsp/developer/appinfoview.jsp";
	}
	...
	public String modifyAppInfo(@RequestParam("id") String id,
		...
		model.addAttribute(appInfo);
		model.addAttribute("fileUploadError",fileUploadError);
		return "/WEB-INF/jsp/developer/appinfomodify.jsp";
	}
	...
	public String modifyAppVersion(@RequestParam("vid") String versionId,
		...
		model.addAttribute("appVersionList",appVersionList);
		model.addAttribute("fileUploadError",fileUploadError);
		return "/WEB-INF/jsp/developer/appversionmodify.jsp";
	}

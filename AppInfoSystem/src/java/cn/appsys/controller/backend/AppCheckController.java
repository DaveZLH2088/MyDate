...
@Controller
@RequestMapping(value="/managerUse/backend/app")
public class AppCheckController {
	...
	public String getAppInfoList(Model model,HttpSession session,
		...
		return "/WEB-INF/jsp/backend/applist.jsp";
	}
	...
	public String check(@RequestParam(value="aid",required=false) String appId,
		...
		return "/WEB-INF/jsp/backend/appcheck.jsp";
	}
	...
	public String checkSave(AppInfo appInfo){
		...
		try {
			if(appService.updateSatus(appInfo.getStatus(),appInfo.getId())){
				return "redirect:/managerUse/backend/app/list";
			}
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
